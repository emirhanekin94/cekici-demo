/**
 * XXX OTO ÇEKİCİ & OTO ÇEKİCİ - GELİŞMİŞ ETKİLEŞİM, ÖZEL BÖLGE SEÇİCİ VE WHATSAPP FORMU
 */
  ...
  geoLocationBtns.forEach(btn => {
    btn.addEventListener('click', (e) => {
      ...
      const onLocationSuccess = (position) => {
        ...
        const message = `Merhaba XXX Oto Çekici, yolda kaldım acil çekiciye ihtiyacım var.\n📍 Canlı GPS Konumum: ${mapsUrl}`;
